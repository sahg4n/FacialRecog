...
original_image = cv2.imread('/home/sahgan/Desktop/quarantineStuff/Udemy/ComputerVisionFacialRecognition/images/tg.jpg')
...
image_to_recognize = fr.load_image_file('/home/sahgan/Desktop/quarantineStuff/Udemy/ComputerVisionFacialRecognition/images/tg.jpg')
...
for current_face_location, current_face_encoding in zip(all_locations, all_encodings):
    ...
    if True in matches:
        ...
        for i in indices:
            matchedFaceEnc.append(known_face_encodings[i])
        faceDist = fr.face_distance(matchedFaceEnc, current_face_encoding)
