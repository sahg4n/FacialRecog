...
original_image = cv2.imread('/home/sahgan/Desktop/quarantineStuff/Udemy/ComputerVisionFacialRecognition/images/diwalimd.jpg')
...
niharika = fr.load_image_file('/home/sahgan/Desktop/quarantineStuff/Udemy/ComputerVisionFacialRecognition/niharika1.jpg') 
...
image_to_recognize = fr.load_image_file('/home/sahgan/Desktop/quarantineStuff/Udemy/ComputerVisionFacialRecognition/images/diwalimd.jpg')
...
for current_face_location, current_face_encoding in zip(all_locations, all_encodings):
    ...
    if True in matches:
        ...
        name_person = known_face_names[firstMatchIndex]
    ...
    cv2.putText(original_image, name_person+ str(top)+''+str(bottom), (left, bottom), font, 2.9, (255,255,255))
